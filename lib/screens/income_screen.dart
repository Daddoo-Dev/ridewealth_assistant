...
class _IncomeScreenState extends State<IncomeScreen> {
    ...
    if (amountController.text.isNotEmpty &&
      ...
      try {
        ...
        if (editingIncome != null) {
          await _db
              .collection('income')
              .doc(editingIncome!['id'])
              .update(incomeData);
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text("Income updated successfully")),
          );
        } else {
          await _db.collection('income').add(incomeData);
          ScaffoldMessenger.of(context).showSnackBar(
  ...
  void editIncome(Map<String, dynamic> income) {
    setState(() {
      ...
      selectedDate = parseDate(income['date']);
    });
  }
  ...
  Future<void> deleteIncome(String id) async {
    ...
    if (confirmDelete == true) {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Income entry deleted successfully")),
        );
        await loadIncomes();
      } catch (e) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content:
                  Text("Failed to delete income entry. Please try again.")),
        );
      }
    }
  }

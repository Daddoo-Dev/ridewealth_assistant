class Environment {
  ...
  // Android App Actions ("log a start mileage" voice command). Off until there's a
  // car with Android Auto to validate the in-car experience against.
  static const bool enableAppActions = false;
}